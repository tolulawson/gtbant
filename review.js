...
import {
  useTheme, Box, Heading, Text, Button, Stack, Divider, Avatar, Img, Collapse,
  ...
  return (
    <Stack borderRadius={12} bg='gt.50' p={[3,, 2]} direction='row' color='gray.600' spacing={[6,, 10]}>
      ...
      <Stack w={['80%',, '50%']}>
        ...
        <Text fontSize='lg' fontWeight='medium' lineHeight={1}>{reviewSubject}</Text>
        <TruncatedText text={reviewBody} limit={15} fontSize='sm' lineHeight={1.3} sx={{ transition: '0.2s ease' }} />
      </Stack>
